...
void requestsession() {
    ...
    session[MaxSessionIndex].mentorID = ifIDvalid;
    session[MaxSessionIndex].skillName = ifSkillvalid;
    session[MaxSessionIndex].learnerID = learnerloginID;
    ...
    write_session_data << session[MaxSessionIndex].sessionID <<
        ...
        "|" << session[MaxSessionIndex].skillName <<
